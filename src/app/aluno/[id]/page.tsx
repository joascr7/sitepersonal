...
useEffect(() => {
 ...
 if (loading) return (
  ...
  return (
    // pb-0 pois o espaçamento agora está no container interno
    // pt-20 compensa a Navbar superior fixa
    <main className="w-full bg-black text-white pt-20 px-4">
      {/* Container centralizado. O pb-32 garante que o scroll desça abaixo da Navbar inferior */}
      <div className="max-w-md mx-auto flex flex-col space-y-2 pb-32">
        ...
        {/* ESPAÇADOR DE SEGURANÇA: Garante o scroll abaixo da navbar inferior */}
