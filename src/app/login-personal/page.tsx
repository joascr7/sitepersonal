    ...
    <main className="flex flex-col items-center justify-center min-h-screen bg-gray-50 p-6">
      <div className="bg-white p-10 rounded-3xl shadow-sm border border-gray-100 w-full max-w-sm text-center">
        ...
        <div className="relative w-full mb-2">
          <input 
            className="w-full p-4 border border-gray-200 rounded-xl focus:ring-2 focus:ring-gray-900 outline-none transition" 
        ...
        <p className="text-sm mb-8 mt-2 text-gray-500">
          Esqueceu a senha? 
          <span onClick={handleResetPassword} className="font-bold underline cursor-pointer ml-1 text-gray-900">Recuperar</span>
        </p>
        
        <button 
          onClick={handleLogin} 
          className="w-full bg-gray-900 hover:bg-black text-white py-4 rounded-xl font-bold mb-4 transition-all active:scale-[0.98] shadow-sm"
        >
          Entrar
        </button>
        ...
        <button 
          ...
          className="w-full bg-gray-50 hover:bg-gray-100 text-gray-900 py-4 rounded-xl font-bold transition-all active:scale-[0.98]"
        >
          Não tenho uma conta
        </button>
      </div>
