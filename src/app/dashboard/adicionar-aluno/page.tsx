...
export default function AdicionarAluno() {
  ...
  // Otimização: Adicionado autoComplete e inputMode para facilitar no mobile
  const InputField = ({ label, name, type = "text", placeholder, autoComplete, ...props }: any) => (
  ...
  return (
    <main className="min-h-screen bg-gray-50 flex items-start justify-center p-4 md:p-6 pb-20">
      <div className="w-full max-w-lg bg-white p-6 md:p-10 rounded-3xl shadow-sm border border-gray-100">
        ...
        <div className="space-y-6">
          <section className="space-y-4">
            ...
            <InputField label="E-mail" name="email" type="email" autoComplete="email" placeholder="aluno@email.com" />
            <InputField label="Senha" name="password" type="password" autoComplete="new-password" placeholder="••••••••" />
          </section>
          ...
          <section className="space-y-4">
            ...
            <InputField label="Nome Completo" name="nome" autoComplete="name" placeholder="Nome do aluno" />
            <div className="grid grid-cols-2 gap-4">
              <InputField label="WhatsApp" name="telefone" type="tel" placeholder="(00) 00000-0000" />
              <InputField label="Vencimento" name="dataVencimento" type="date" />
            </div>
            <InputField label="Objetivo" name="objetivo" placeholder="Ex: Hipertrofia" />
            <InputField label="Link de Pagamento" name="linkPagamento" type="url" placeholder="https://..." />
          </section>
        </div>
