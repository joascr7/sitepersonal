    ...
    <main className="w-full min-h-screen bg-black text-white pt-20 pb-10 px-4">
      <div className="max-w-4xl mx-auto space-y-2">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="lg:col-span-2 bg-neutral-950/80 backdrop-blur-xl p-8 rounded-[2.5rem] border border-white/5 shadow-2xl">
          ...
          {/* Melhores Marcas */}
          <div className="bg-neutral-950/80 backdrop-blur-xl p-8 rounded-[2.5rem] border border-white/5 shadow-2xl flex flex-col justify-between">
